...
{
if(tb > 5000000)
return "Anda mendapatkan hadiah sarung tangan, helmet dan jersey";
else
if(tb > 3000000 && tb <= 5000000)
return "Anda mendapatkan hadiah sarung tangan dan helmet";
else
if(tb > 2000000 && tb <= 3000000)
return "Anda mendapatkan hadiah helmet";
else
return "-";
...
cout<<"\t No. Nama     jenis        tipe      data[a].harga         jumlah      total "<<endl;
cout<<"\t --------------------------------------------------------------------"<<endl;
for(a=1;a<=jmlh;a++){
...
cout<<setprecision(2)<<" "<<data[a].js;
cout<<setprecision(2)<<" "<<data[a].ts;
cout<<setprecision(2)<<" "<<data[a].harga;
cout<<setprecision(2)<<" "<<data[a].jb;
cout<<setprecision(2)<<" "<<data[a].tb<<endl;
cout<<setprecision(2)<<"\t  "<<had(data[a].tb);
